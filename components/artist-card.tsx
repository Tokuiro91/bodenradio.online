...
function SoundcloudIcon({ className }: { className?: string }) {
  return (
    <>
      {/* Mobile: SimpleIcons fill — clear at 20px */}
      <svg className={`${className} lg:hidden`} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      ...
      <svg className={`${className} hidden lg:block`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            {!isAd && (
              ...
              >
                {onToggleFavorite && (
                  ...
                  >
                    <Star className={`w-5 h-5 lg:w-4 lg:h-4 ${isFavorite ? "fill-current" : ""}`} />
                  </button>
                )}
                {artist.instagramUrl && (
                  <a
                  ...
                  >
                    <InstagramIcon className="w-5 h-5 lg:w-4 lg:h-4" />
                  </a>
                )}
                {artist.soundcloudUrl && (
                  ...
                  >
                    <SoundcloudIcon className="w-5 h-[22px] lg:w-4 lg:h-4" />
                  </a>
                )}
                {artist.bandcampUrl && (
                  <a
                    ...
                    aria-label="Bandcamp"
                  >
                    <BandcampIcon className="w-5 h-5 lg:w-4 lg:h-4" />
                  </a>
                )}
              </div>
            )}
